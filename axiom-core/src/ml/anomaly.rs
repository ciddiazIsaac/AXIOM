...
impl AnomalyDetector {
    ...
    /// Realiza una inferencia asíncrona delegando a un thread de `spawn_blocking` 
    /// para no bloquear el runtime de Tokio.
    /// Devuelve el anomaly_score (0.0 = normal, 1.0 = anomalía extrema) o None en caso de error.
    pub async fn predict(&self, features: Vec<f32>) -> Option<f32> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let mut session_guard = session_clone.lock().map_err(|e| {
